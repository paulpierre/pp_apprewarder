...
import com.stackpunch.apprewarder.MainActivity;
...
public class Facebook {
    ...
    public String fbToken = mAccessToken;
	...
	private void startDialogAuth(Activity activity, String applicationId,
        ...
        dialog(activity, LOGIN, params, new DialogListener() {
            ...
            public void onComplete(Bundle values) {
                ...
                if (isSessionValid()) {
					Log.d("Facebook-authorize", "Login Success! values: " + values +" access_token="
                ...
                if (error != null) {
                    ...
                    if (isSessionValid()) {
                        ...
                        Log.d("Facebook-authorize",
                                "Login Success! data: "  + data.getExtras().toString() + " access_token="
										+ getAccessToken() + " expires="
										+ getAccessExpires());
